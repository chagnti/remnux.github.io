...
If using the OVF/OVA virtual appliance with VMware, you can optionally [install VMware Tools in REMnux](http://zeltser.com/reverse-malware/install-vmware-tools.html) to automatically adjust the screen size.
